...
| `maxIndexableHeaderTagLevel`             | number                                                                      | `3`       | Set HTML header tags from level 1 to x to be indexed. The default is 3, i.e., "<h1> <h2> <h3>". The value should be between 1 and 6. |
